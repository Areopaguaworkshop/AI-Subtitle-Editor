...
def _(dspy, parse_subtitle, spacy):
    def rewrite_text(file_path):
        ...
        lm=dspy.LM(model='ollama/qwen2.5', base_url= "http://localhost:11434", max_tokens= 15000, timeout_s=1200)
...
@app.cell
def _(process_vtt):
    file_path = "/home/ajiap/Documents/person/Ware11-20240110.cc.vtt"
